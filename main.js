...
drawCountyCount(CountArray, overlay.accidents_county, 6, "#85144b", "Total");
...
slider.onchange = function () {
    ...
    drawCountyCount(dataMonth, overlay.accidents_county_month, 200, "#39CCCC", month);
};
...
playButton.onclick = function () {
    ...
    if (runningAnimation) {
        ...
        overlay.accidents_county_month.clearLayers();
        drawCountyCount(AllCountsPerMonth[slider.value][1], overlay.accidents_county_month, 200, "#39CCCC", AllCountsPerMonth[slider.value][0]); //Kreise zeichnen, wenn pausiert
        overlay.accidents_county_month.addTo(map);
